...
(function (RSADemo) {
    ...
    const BigInteger = Lib.BigInteger;
    {
        ...
        function update(show_branch, set_value, vars) {
            ...
            set_value("demo_id_8", RSADemo.format_list("", " \\ +\\  ", "", list4));
            set_value("demo_id_10", RSADemo.format_list("", " {^{+}}", "", list5));
            set_value("demo_id_11", RSADemo.format_list("", " ", "", list6));
            set_value("demo_id_13", RSADemo.format_list("", " ", "", list7));
            ...
            set_value("demo_id_17", RSADemo.format_list("", " ", "", list7));
            set_value("demo_id_18", RSADemo.format_list("", " ", "", list8));
            set_value("demo_id_19", RSADemo.format_list("", " ", "", list9));
            if (list9.length > 2) {
                ...
                set_value("demo_id_25", RSADemo.format_list("", " ", "", list11l));
                set_value("demo_id_26", list9[list9.length - 1]);
                set_value("demo_id_27", RSADemo.format_list("", " ", "", list11r));
            }
            else {
