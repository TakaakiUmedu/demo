...
(function (RSADemo) {
    ...
    const BigInteger = Lib.BigInteger;
    {
        ...
        function update(show_branch, set_value, vars) {
            ...
            set_value("demo_id_7", RSADemo.format_list("", " ", "_{(2)}", list3));
            const list4_0 = [];
            const list4 = [];
            const list5 = [];
            const list6 = [];
            ...
            set_value("demo_id_8", RSADemo.format_set(list4_0, false));
            set_value("demo_id_9", RSADemo.format_list("", " \\ +\\  ", "", list4));
            set_value("demo_id_11", RSADemo.format_list("", " {^{+}}", "", list5));
            set_value("demo_id_12", RSADemo.format_list("", " ", "", list6));
            set_value("demo_id_14", RSADemo.format_list("", "\\;", "", list7));
            ...
            tbody10.appendChild(RSADemo.tr("y_0", "=", "a \\ \\% \\ l", "=", y.toString()));
            for (let i = 1; i < list3.length; i++) {
                y = y.mul(y).mod(l);
                tbody10.appendChild(RSADemo.tr("y_{" + i + "}", "=", "y_{" + (i - 1) + "}^2 \\ \\% \\ l", "=", y.toString()));
                calc_count += 2;
            ...
            set_value("demo_id_18", RSADemo.format_list("", "\\; ", "", list7));
            set_value("demo_id_19", RSADemo.format_list("", " ", "", list8));
            set_value("demo_id_20", RSADemo.format_list("", "\\; ", "", list9));
            if (list9.length > 2) {
                ...
                set_value("demo_id_26", RSADemo.format_list("", " ", "", list11l));
                set_value("demo_id_27", list9[list9.length - 1]);
                set_value("demo_id_28", RSADemo.format_list("", " ", "", list11r));
            }
            else {
