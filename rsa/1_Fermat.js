    ...
    const BigInteger = Lib.BigInteger;
    {
        ...
        function update(show_branch, set_value, vars) {
            const { p } = vars;
            {
                ...
                class Calc {
                    constructor() {
                        this.elem = Dom.combineTables(Dom.getInputs("calculate", "p", "mod"), Dom.getSelects("count"), Dom.getElements("result"));
                        this.p = 0;
                        this.xMax = 0;
                        this.yMax = 0;
                        this.trs = [];
                        this.tbody = Dom.elem("tbody");
                        this.tfoot_tr = Dom.elem("tr");
                        this.explanation = Dom.getElement("explanation");
                        this.calcNextColumn = () => {
